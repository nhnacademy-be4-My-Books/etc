...
DROP TABLE IF EXISTS `delivery_name_rule`;
...
CREATE TABLE `user` (
	...
	`user_latest_login`	datetime	NULL,
...
CREATE TABLE `delivery_rule` (
	...
	`delivery_name_rule_id`	int	NOT NULL,
...
CREATE TABLE `user_grade` (
	...
	`user_grade_name`	varchar(10)	NOT NULL UNIQUE,
...
CREATE TABLE `user_coupon` (
	...
	`user_coupon_created_at`	date	NOT NULL,
...
CREATE TABLE `orders_status` (
	`orders_status_id`	int	NOT NULL Auto_Increment,
...
CREATE TABLE `order_detail_status` (
	`order_detail_status_id`	int	NOT NULL Auto_Increment,
	`order_detail_status_name`	varchar(20)	NOT NULL,
    
    CONSTRAINT PK_ORDER_DETAIL_STATUS PRIMARY KEY(`order_detail_status_id`)
);

CREATE TABLE `point_name_rule` (
	`point_name_rule_id`	int	NOT NULL Auto_Increment,
	`point_name`	varchar(20)	NOT NULL,
    
    CONSTRAINT PK_POINT_NAME_RULE PRIMARY KEY(`point_name_rule_id`)
);

CREATE TABLE `return_name_rule` (
	`return_name_rule_id`	int	NOT NULL Auto_Increment,
	`return_name`	varchar(50)	NOT NULL,
	`return_name_created_at`	date	NOT NULL,
    
    CONSTRAINT PK_RETURN_NAME_RULE PRIMARY KEY(`return_name_rule_id`)
);

CREATE TABLE `delivery_name_rule` (
	`delivery_name_rule_id`	int	NOT NULL Auto_Increment,
	`delivery_name`	varchar(50)	NOT NULL,
	`delivery_name_created_at`	date	NOT NULL,
    
    CONSTRAINT PK_DELIVERY_NAME_RULE PRIMARY KEY(`delivery_name_rule_id`)
);

CREATE TABLE `image_status` (
	`image_status_id`	int	NOT NULL Auto_Increment,
...
ALTER TABLE `delivery_rule` ADD CONSTRAINT `FK_delivery_name_rule_TO_delivery_rule_1` FOREIGN KEY (
	`delivery_name_rule_id`
)
REFERENCES `delivery_name_rule` (
	`delivery_name_rule_id`
);
